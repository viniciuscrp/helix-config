...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_CAPS,        KC_TRANSPARENT, KC_NO,          MS_JIGGLER,        KC_LEFT_GUI,       CW_TOGG,        LT(_FN, KC_SPACE),        LT(_NAV, KC_BSPC),  TT(_MOUSE),        KC_LEFT_ALT,       KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [_ALT] = LAYOUT(
